...
public class GroupData implements Serializable {
    ...
    public boolean put(Long key, Group value) {
        DatabaseEntry keyEntry = new DatabaseEntry();
        LongBinding.longToEntry(key, keyEntry);
        DatabaseEntry valueEntry = new DatabaseEntry();
        EntryBinding valueBinding = new SerialBinding(classCatalog, Group.class);
    ...
    public Group get(Long key) {
        ...
        if (values.get(null, keyEntry, valueEntry, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
            EntryBinding valueBinding = new SerialBinding(classCatalog, Group.class);
            return (Group) valueBinding.entryToObject(valueEntry);
        }
        return null;
    }
