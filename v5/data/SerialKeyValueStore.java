 ...
 * @author admin
 */
public class SerialKeyValueStore<K, V> implements KeyValueStore<K, V> {
    ...
    private static final Logger log = Logger.getLogger(SerialKeyValueStore.class.getName());

    public SerialKeyValueStore(Class<K> keyClass, Class<V> valueClass) {
