...
import com.ontopad.identity.IdentityData;
 ...
 */
@ApplicationScoped
public class ServletPolicyData implements Serializable {
    ...
    private static final String name = "AccessPolicy";
    ...
    public boolean put(String key, ServletPolicy value) {
        DatabaseEntry keyEntry = new DatabaseEntry();
        StringBinding.stringToEntry(key, keyEntry);

        DatabaseEntry valueEntry = new DatabaseEntry();
        EntryBinding valueBinding = new SerialBinding(classCatalog, ServletPolicy.class);
    ...
    public ServletPolicy get(String key) {
        DatabaseEntry keyEntry = new DatabaseEntry();
        StringBinding.stringToEntry(key, keyEntry);
        ...
        if (values.get(null, keyEntry, valueEntry, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
            EntryBinding valueBinding = new SerialBinding(classCatalog, ServletPolicy.class);
            return (ServletPolicy) valueBinding.entryToObject(valueEntry);
        }
        return null;
    }
