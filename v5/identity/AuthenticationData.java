...
public class AuthenticationData implements Serializable {
    ...
    public boolean put(String key, AuthenticationInfo value) {
        DatabaseEntry keyEntry = new DatabaseEntry();
        StringBinding.stringToEntry(key, keyEntry);

        DatabaseEntry valueEntry = new DatabaseEntry();
        EntryBinding valueBinding = new SerialBinding(classCatalog, AuthenticationInfo.class);
    ...
    public AuthenticationInfo get(String key) {
        DatabaseEntry keyEntry = new DatabaseEntry();
        StringBinding.stringToEntry(key, keyEntry);
        ...
        if (values.get(null, keyEntry, valueEntry, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
            EntryBinding valueBinding = new SerialBinding(classCatalog, AuthenticationInfo.class);
            return (AuthenticationInfo) valueBinding.entryToObject(valueEntry);
        }
        return null;
    }
